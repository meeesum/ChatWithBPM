      ...
      <div className="w-full max-w-6xl bg-white rounded-lg shadow-2xl flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/3 p-8 flex flex-col justify-center">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
             ...
             {/* Username Field */}
             <div>
              <label htmlFor="username" className="block text-sm font-semibold mb-2 text-left">
                Username
              </label>
            ...
            <div>
              <label htmlFor="confirm-password" className="block text-sm font-semibold mb-2 text-left">
                Confirm Password
              </label>
              <div className="flex items-center border rounded-md p-2">
                <FaKey className="text-gray-400 mr-3" />
